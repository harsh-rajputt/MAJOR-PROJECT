...
const listingSchema = new Schema({
    ...
    image: {
       ...
       set: (v) => 
        v === ""
        ? "https://images.unsplash.com/photo-1471357674240-e1a485acb3e1?q=80&w=875&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
        : v,
    },
    price: {
        type: Number,
